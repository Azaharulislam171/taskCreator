...
<form action="islamEdit2.php"  method="post">
    <table id="mytable">
        <br>
        <tr>
            ...
            <br>
            <textarea type="text" name="desaz" value="<?php echo $description ?>" rows="6" cols="83">
                </textarea>
            <br>
            <br>
            ...
            <br>
            <br>
            <a class="cancel" href="completed-test.php">cancel</a>
        </tr>
        <br>
        <br>
        <br>
